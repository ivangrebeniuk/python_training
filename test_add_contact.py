...
class AddTestContact(unittest.TestCase):
    ...
    def fill_contact_data(self, wd, contact):
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_data(wd, Contact(first_name="John", middle_name="Doe", last_name="Doe", nickname="Sponge Bob", title="Mr", company="Test company", address="Russia, Moscow", home_phone="123456",
