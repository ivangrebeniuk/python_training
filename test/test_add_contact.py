...
def test_add_contact(app):
    ...
    app.contact.fill_contact_data(Contact(first_name="John", middle_name="Doe", last_name="Doe", nickname="Sponge Bob", title="Mr", company="Test company", address="Russia, Moscow", home_phone="123456",
