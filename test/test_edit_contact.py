...
def test_edit_contact(app):
    ...
    app.contact.edit_contact_by_index(Contact(first_name="Jane", middle_name="Zzz", last_name="Aaa", nickname="Patric Star", title="Ms", company="Updated company", address="Bikini bottom, World Ocean", home_phone="000111",
                                              ...
                                              secondary_address="Test secondary address", phone2="01", note="Hello world"), index)
